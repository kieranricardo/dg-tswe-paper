...
for dt in dts:
    ...
    entropy_error = abs(solver.entropy_list[-1] - solver.entropy_list[0]) / solver.entropy_list[0]
...
r, *_ = linregress(np.log(dts), np.log(np.array(entropy_errors)))
print('Entropy convergence:', r)
