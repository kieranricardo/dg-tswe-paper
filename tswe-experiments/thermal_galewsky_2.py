...
if mode == 'run':
    ...
    for exp, cls in zip(exp_names, classes):
        ...
        fn_template = f"{exp}_day_{ndays}.npy"
    ...
    labels = ['Diss.', 'Cons.']
    # exp_names = [f'DG_cntr_res_6x{nx}x{ny}', f'EntCons_DG_cntr_res_6x{nx}x{ny}', f'EngCons_DG_cntr_res_6x{nx}x{ny}']
    # labels = ['Con.', 'Entropy cons.', 'Energy cons.']
